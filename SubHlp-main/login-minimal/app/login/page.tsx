...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-blue-50 overflow-hidden">
      <div className="flex-1 flex flex-col justify-center items-center w-full">
        <div className="w-full max-w-sm">
          {/* ヘッダー */}
          <div className="text-center mb-4">
            <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white p-2 rounded-lg inline-block mb-2">
              <CreditCard className="h-6 w-6" />
            </div>
            <h1 className="text-2xl font-bold text-gray-900">サブ助</h1>
            <p className="text-gray-600 mt-1 text-sm">サブスクリプション管理アプリ</p>
          </div>
          ...
          {showReset ? (
            <Card className="shadow-xl">
              <CardHeader>
                <CardTitle className="text-center text-base">パスワードリセット</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  <div className="space-y-1">
                    <Label htmlFor="resetEmail" className="text-sm">登録メールアドレス</Label>
                    <Input
                      id="resetEmail"
                      type="email"
                      value={resetEmail}
                  ...
                  <Button type="button" onClick={handlePasswordReset} className="w-full text-sm py-2">
                    パスワードリセットメール送信
                  </Button>
                  {resetMsg && <p className="text-xs mt-1 text-center">{resetMsg}</p>}
                  <Button type="button" variant="ghost" onClick={() => setShowReset(false)} className="w-full mt-1 text-sm py-2">
                    戻る
                  </Button>
                </div>
              </CardContent>
            ...
            <>
              ...
              <Card className="shadow-xl">
                <CardHeader>
                  <CardTitle className="text-center text-base">{isSignUp ? "アカウント作成" : "ログイン"}</CardTitle>
                </CardHeader>
                <CardContent>
